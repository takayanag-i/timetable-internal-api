...
DROP TABLE IF EXISTS SCHOOL_DAY CASCADE;
DROP TABLE IF EXISTS INSTRUCTOR CASCADE;
DROP TABLE IF EXISTS ATTENDANCE_DAY CASCADE;
DROP TABLE IF EXISTS SUBJECT CASCADE;
DROP TABLE IF EXISTS ROOM CASCADE;
DROP TABLE IF EXISTS HOMEROOM CASCADE;
DROP TABLE IF EXISTS HOMEROOM_DAY CASCADE;
DROP TABLE IF EXISTS BLOCK CASCADE;
DROP TABLE IF EXISTS LANE CASCADE;
DROP TABLE IF EXISTS COURSE CASCADE;
DROP TABLE IF EXISTS COURSE_DETAIL CASCADE;
DROP TABLE IF EXISTS LANE_COURSE CASCADE;
DROP TABLE IF EXISTS CONSTRAINT_DEFINITION CASCADE;
DROP TABLE IF EXISTS CONSTRAINT_DEFINITION_MASTER CASCADE;
DROP TABLE IF EXISTS CONSTRAINT_PARAMETER_MASTER CASCADE;
DROP TABLE IF EXISTS TIMETABLE_RESULT CASCADE;
DROP TABLE IF EXISTS TIMETABLE_ENTRY CASCADE;
DROP TABLE IF EXISTS CONSTRAINT_VIOLATION CASCADE;

DROP SEQUENCE IF EXISTS GRADE_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS SCHOOL_DAY_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS INSTRUCTOR_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS ATTENDANCE_DAY_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS SUBJECT_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS ROOM_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS HOMEROOM_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS HOMEROOM_DAY_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS BLOCK_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS LANE_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS COURSE_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS CONSTRAINT_DEFINITION_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS TIMETABLE_RESULT_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS TIMETABLE_ENTRY_ID_SEQ CASCADE;
DROP SEQUENCE IF EXISTS CONSTRAINT_VIOLATION_ID_SEQ CASCADE;
...
CREATE TABLE SUBJECT (
    id BIGINT NOT NULL DEFAULT nextval('SUBJECT_ID_SEQ'),
    ttid UUID NOT NULL,
    discipline_code VARCHAR(255) NOT NULL,

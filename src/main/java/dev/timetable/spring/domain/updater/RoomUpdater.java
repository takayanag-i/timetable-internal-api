...
import dev.timetable.spring.dto.room.UpdateRoomInput;
...
public class RoomUpdater {
     ...
     * 教室Entityを生成する.
     *
     * @param request 教室更新リクエスト
     * @param ttid 時間割ID
     * @param updatedBy 更新者
     * @param now 現在日時
     * @return 教室Entity
     */
    public static RoomEntity create(UpdateRoomInput request, UUID ttid, String updatedBy, OffsetDateTime now) {
     ...
     * @param now 現在日時
     */
    public static void update(RoomEntity entity, UpdateRoomInput request, String updatedBy, OffsetDateTime now) {
